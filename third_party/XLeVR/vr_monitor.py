...
def import_xlevr_modules():
    ...
    try:
        ...
        from xlevr.inputs.vr_ws_server2 import VRWebSocketServer
...
class SimpleHTTPServer:
    ...
    async def start(self):
        ...
        print(f"🌐 HTTP server started on 0.0.0.0:{self.port}")
...
class VRMonitor:
    ...
    def initialize(self):
        ...
        self.config.enable_https = False  # Enable HTTPS server, VR requires web interface
        self.config.websocket_port = 8001 # 确保这里也是 8001
        ...
        try:
            ...
            self.http_server = SimpleHTTPServer(port=8000)
        except Exception as e:
