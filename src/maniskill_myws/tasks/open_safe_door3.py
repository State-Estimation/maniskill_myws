...
@register_env("OpenSafeDoor-v3", max_episode_steps=500)
class OpenSafeDoor3Env(BaseEnv):
    """
    ...
    def _load_scene(self, options: dict):
        ...
        asset_dir = importlib_resources.files("maniskill_myws").joinpath("assets/door2/urdf")
        ...
        self.safe.set_pose(sapien.Pose(p=[0.5, 0.0, self._safe_table_z], q=[0.707, 0.707, 0, 0]))
